...
import static org.metastatic.jessie.provider.ClientHandshake.State.*;
...
import org.metastatic.jessie.provider.ServerNameList.NameType;
...
public class ClientHandshake extends AbstractHandshake {
    ...
    /* (non-Javadoc)
     * @see org.metastatic.jessie.provider.AbstractHandshake#implHandleInput()
     */
    @Override
    protected HandshakeStatus implHandleInput() throws SSLException {
        if (state == DONE)
    ...
    /* (non-Javadoc)
     * @see org.metastatic.jessie.provider.AbstractHandshake#implHandleOutput(java.nio.ByteBuffer)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.metastatic.jessie.provider.AbstractHandshake#status()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.metastatic.jessie.provider.AbstractHandshake#handleV2Hello(java.nio.ByteBuffer)
     */
    @Override
    ...
    class ClientDHGen extends DelegatedTask {
        ...
        public void implRun()
                ...
                SSLException {
            if (Debug.DEBUG)
                logger.log(Level.FINE, "running client DH phase");
