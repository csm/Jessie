...
final class DiffieHellman
{
     ...
     */
    static DHParameterSpec getParams()
    {
        BigInteger p = DiffieHellman.GROUP_5;
        String group = AccessController.doPrivileged
                ((java.security.PrivilegedAction<String>) () -> Security.getProperty("org.metastatic.jessie.key.dh.group"));
        if (group != null)
        {
            group = group.trim();
            if (group.equals("1"))
        ...
        return new DHParameterSpec(p, DH_G);
    }
