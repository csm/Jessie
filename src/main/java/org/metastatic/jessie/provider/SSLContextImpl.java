...
public final class SSLContextImpl extends SSLContextSpi {
    ...
    protected
    @Override
    synchronized SSLSessionContext engineGetClientSessionContext() {
    ...
    protected
    @Override
    void engineInit(KeyManager[] keyManagers,
    ...
    private SecureRandom defaultRandom() {
        String alg = AccessController.doPrivileged((PrivilegedAction<String>) () -> Security.getProperty("org.metastatic.jessie.secureRandom"));
        if (alg == null)
            alg = "Fortuna";
