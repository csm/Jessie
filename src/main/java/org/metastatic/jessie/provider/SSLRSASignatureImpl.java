...
{
    private static final Logger logger = Logger.getLogger(SSLRSASignatureImpl.class.getName());
    ...
    protected void engineUpdate(byte b) throws SignatureException
    {
        ...
        if (Debug.DEBUG)
            logger.log(Level.FINE, "SSL/RSA update 0x{0}",
            ...
            throws SignatureException
    {
        if (!initSign && !initVerify)
            throw new IllegalStateException("not initialized");
        if (Debug.DEBUG)
            logger.log(Level.FINE, "SSL/RSA update\n{0}",
    ...
    protected byte[] engineSign() throws SignatureException
    {
        ...
        BigInteger EM = null; // TODO RSA.sign(privkey, EB);
        return Util.trim(EM);
    }
            ...
            throws SignatureException
    {
        ...
        BigInteger EB = null; // TODO RSA.verify(pubkey, EM);
        ...
        if (Debug.DEBUG)
            logger.log(Level.FINE, "SSL/RSA d1:{0} d2:{1}",
                       new Object[] { Util.toHexString(d1, ':'), Util.toHexString(d2, ':') });
