...
/**
 * A very-non-secure random number generator, for testing purposes.
 */
public class InsecureRandom extends SecureRandomSpi
{
    ...
    public static SecureRandom getInsecureRandom()
    {
        return new SecureRandom(new InsecureRandom(), new Provider("fake", 1.0, "fake"){}){};
    }
