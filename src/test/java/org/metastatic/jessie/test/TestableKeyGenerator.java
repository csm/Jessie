...
public class TestableKeyGenerator extends KeyGenerator
{
    public TestableKeyGenerator(KeyGeneratorSpi keyGeneratorSpi, Provider provider, String s)
    {
        super(keyGeneratorSpi, provider, s);
    }
}
